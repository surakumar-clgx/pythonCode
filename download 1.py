...
if __name__ == "__main__":
  ...
  ocr_path=r"\\filer-argentina-dev\Argentina\Shared Folder\Mohamed_Abdullah\NY\Data_Extraction_raw_june" #destination path for ocr
  #ocr_path=r"C:\Users\mabdullah\OneDrive - CoreLogic Solutions, LLC\Downloads\TN\Data_Extraction_June" #destination path for ocr
  os.mkdir(ocr_path)
  batch=[]
  import pandas as pd
  batch_df=pd.read_csv(r"\\filer-argentina-dev\Argentina\Shared Folder\Mohamed_Abdullah\NY\NY_raw_june_2251.csv") #path here#
