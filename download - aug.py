...
if __name__ == "__main__":
  ...
  ocr_path=r"C:\Users\surakumar\OneDrive - CoreLogic Solutions, LLC\Downloads\NJ\Data_Extraction_dec" #destination path for ocr
  Path(ocr_path).mkdir(exist_ok=True)
  # os.mkdir(ocr_path)
  batch=[]
  import pandas as pd
  batch_df=pd.read_csv(r"C:\Users\surakumar\OneDrive - CoreLogic Solutions, LLC\Downloads\NJ\NJ_set1.1_3644.csv") #path here#
  ...
  print("Downloading complete. Now Merge")
...
# path=r"\\filer-argentina-dev\Argentina\Shared Folder\Suraj\PA\Data_Extraction_Aug"
# import os
# from tqdm import tqdm
